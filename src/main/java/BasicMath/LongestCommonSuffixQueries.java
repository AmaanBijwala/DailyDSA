...
public class FindXSumOfAllKLongSubarraysII {
    ...
    public static long rebalance(TreeSet<Integer> topX, TreeSet<Integer> rest, Map<Integer,Integer> freq, int x, long sumTop)
    {
        // Step 4 logic inline
    ...
    public static void printArray(long[] result){
        for(long i: result){
            System.out.print(i+" ");
        }
    }
